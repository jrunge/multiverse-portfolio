...
/******/ 	__webpack_require__.p = "https://jrunge.github.io/";
/******/
...
var _hedron = __webpack_require__(29);
...
var Wrapper = _styledComponents2.default.div.withConfig({
  ...
  componentId: "s4c44a-0"
})(["position:relative;padding:0 0 4em 0;@media screen and (max-width:736px){padding:4em 0 0 0;}"]);
var Image = _styledComponents2.default.div.withConfig({
  displayName: "Portfolio__Image",
  componentId: "s4c44a-1"
})(["height:calc(40vh - 2em);min-height:20em;background-image:url(", ");background-size:cover;background-position:center center;background-repeat:no-repeat;position:relative;transition:opacity 1.25s ease-in-out;transition-delay:", "s;opacity:", ";&::after{background-image:linear-gradient( to top,rgba(10,17,25,0.35) 5%,rgba(10,17,25,0) 35% );pointer-events:none;background-size:cover;content:\"\";display:block;height:100%;left:0px;position:absolute;top:0px;width:100%;}"], function (props) {
...
var ImageTitle = _styledComponents2.default.h2.withConfig({
  displayName: "Portfolio__ImageTitle",
  componentId: "s4c44a-2"
})(["pointer-events:none;bottom:1.875em;font-size:0.8em;left:2.1875em;position:absolute;z-index:1;margin:0px;"]);
...
var IndexPage = function (_React$Component) {
  ...
  _createClass(IndexPage, [{
    ...
    value: function render() {
      ...
      var titles = ["Magna feugiat lorem", "Nisl adipiscing", "Tempus aliquam veroeros", "Aliquam ipsum sed dolore", "Cursis aliquam nisl", "Sed consequat phasellus", "Mauris id tellus arcu", "Nunc vehicula id nulla", "Neque et faucibus viverra", "Mattis ante fermentum", "Sed ac elementum arcu", "Vehicula id nulla dignissim"];
      return _react2.default.createElement(
        Wrapper,
        null,
        _react2.default.createElement(_header2.default, { open: this.openAbout }),
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            _hedron.Row,
            null,
            (0, _lodash.map)(titles, function (title, i) {
              return _react2.default.createElement(
                _hedron.Column,
                { fluid: true, xs: 12, sm: 6, lg: 4, key: "thumb-" + i },
                _react2.default.createElement(
                  Image,
                  {
                    loading: _this3.state.loading,
                    index: i,
                    onClick: _this3.openPanel,
                    imageUrl: __webpack_require__(41)("./" + (0, _lodash.padStart)(i + 1, 2, "0") + ".jpg")
                  },
                  _react2.default.createElement(
                    ImageTitle,
                    null,
        ...
        _react2.default.createElement(_item2.default, { open: this.state.panelOpen, close: this.closePanel }),
        _react2.default.createElement(_about2.default, { open: this.state.aboutOpen, close: this.closeAbout })
      );
    }
  }]);
...
exports.default = (0, _reactStatic.withSiteData)(IndexPage);
...
var t_0 = (0, _reactUniversalComponent2.default)((0, _universalImport3.default)({
  id: '../src/containers/Portfolio',
  file: '/Users/josrun/Documents/git/blog/multiverse-portfolio/docs/react-static-routes.js',
  load: function load() {
    return Promise.all([new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 6)), (0, _importCss3.default)('src/containers/Portfolio', {
  ...
  path: function path() {
    return _path3.default.join(__dirname, '../src/containers/Portfolio');
  },
  resolve: function resolve() {
    return /*require.resolve*/(6);
  },
  chunkName: function chunkName() {
    return 'src/containers/Portfolio';
  }
}), universalOptions);
...
var _freeSolidSvgIcons = __webpack_require__(8);
...
var Header = _styledComponents2.default.header.withConfig({
  ...
  componentId: 'sc-1oxl6fu-0'
})(['transform:translateY(', ');transition:transform 1s ease;background:#1f2224;bottom:-1em;height:5em;left:0;line-height:4em;padding:0 1.5em;position:fixed;user-select:none;width:100%;z-index:10002;h1{color:#a0a0a1;display:inline-block;font-size:1em;line-height:1;margin:0;vertical-align:middle;a{border:0;color:inherit;&:hover{color:inherit !important;}}}nav{position:absolute;right:0;top:0;> ul{list-style:none;margin:0;padding:0;> li{display:inline-block;padding:0;a{transition:background-color 0.2s ease;border:0;color:#ffffff;display:inline-block;letter-spacing:0.1em;padding:0 1.65em;text-transform:uppercase;&.icon{&:before{color:#505051;float:right;margin-left:0.75em;}}&:hover{color:#ffffff !important;}&.active{background-color:#242629;}}}}}@media screen and (max-width:736px){transform:translateY(', ');', ' bottom:auto;height:4em;padding:0 1em;top:0;h1{font-size:0.9em;}nav{> ul{> li{a{font-size:0.9em;padding:0 1.15em;}}}}}'], function (props) {
...
var MyHeader = function (_React$Component) {
  ...
  function MyHeader(props) {
    ...
    var _this = _possibleConstructorReturn(this, (MyHeader.__proto__ || Object.getPrototypeOf(MyHeader)).call(this, props));
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                'a',
                { href: '#footer', onClick: this.props.open },
                'About ',
                _react2.default.createElement(_reactFontawesome.FontAwesomeIcon, { icon: _freeSolidSvgIcons.faInfoCircle })
              )
            )
          )
        )
...
var Footer = _styledComponents2.default.footer.withConfig({
  displayName: 'item__Footer',
  componentId: 'sc-1x7398-0'
})(['padding:4em 4em 2em 4em;transform:translateY(', ');transition:transform 0.5s ease;-webkit-overflow-scrolling:touch;background:rgba(36,38,41,0.975);bottom:4em;left:0;height:calc(100vh - 4em);overflow-y:auto;position:fixed;width:100%;z-index:10001;.inner{margin:0 auto;max-width:100%;width:75em;}.inner.split{display:flex;}.inner.split > div{margin-left:4em;width:50%;}.inner.split >:first-child{margin-left:0;}> .closer{transition:opacity 0.2s ease-in-out;background-image:url(', ');background-position:center;background-repeat:no-repeat;background-size:3em;cursor:pointer;height:5em;opacity:0.25;position:absolute;right:0;top:0;width:5em;z-index:2;}> .closer:hover{opacity:1.0;}@media screen and (max-width:1280px){padding:3em 3em 1em 3em;> .inner.split > div{margin-left:3em;}> .closer{background-size:2.5em;background-position:75% 25%;}}@media screen and (max-width:980px){> .inner.split{flex-direction:column;}> .inner.split > div{margin-left:0;width:100%;}}@media screen and (max-width:736px){transform:translateY(', ');padding:4em 2em 2em 2em;bottom:auto;top:calc(4em - 1px);}.leftNav,.rightNav{appearance:none;background-color:transparent;border:0;cursor:pointer;outline:none;position:absolute;z-index:4;color:#fff;font-size:2em;padding:50px 15px;top:50%;opacity:0.5;-webkit-transform:translateY(-50%);-ms-transform:translateY(-50%);transform:translateY(-50%);}.rightNav{right:0;}'], function (props) {
  return props.open ? '1px' : '100vh';
}, __webpack_require__(9), function (props) {
  return props.open ? '0' : '-100vh';
});

var MyFooter = function (_React$Component) {
  _inherits(MyFooter, _React$Component);

  function MyFooter(props) {
    _classCallCheck(this, MyFooter);

    var _this = _possibleConstructorReturn(this, (MyFooter.__proto__ || Object.getPrototypeOf(MyFooter)).call(this, props));
  ...
  _createClass(MyFooter, [{
    ...
    value: function render() {
      var images = [{
        original: __webpack_require__(35),
        thumbnail: __webpack_require__(10)
      }, {
        original: __webpack_require__(36),
        thumbnail: __webpack_require__(11)
      }, {
        original: __webpack_require__(37),
        thumbnail: __webpack_require__(12)
      }, {
        original: __webpack_require__(38),
        thumbnail: __webpack_require__(13)
      }, {
        original: __webpack_require__(39),
        thumbnail: __webpack_require__(14)
      }];
      return _react2.default.createElement(
        Footer,
        { loading: this.state.loading, open: this.props.open },
        _react2.default.createElement(
          'div',
              ...
              renderLeftNav: function renderLeftNav(onClick, disabled) {
                return _react2.default.createElement(
                  'span',
                  {
                    ...
                    disabled: disabled,
                    onClick: onClick },
                  _react2.default.createElement(_reactFontawesome.FontAwesomeIcon, { icon: _freeSolidSvgIcons.faChevronLeft })
                );
              },
        ...
        _react2.default.createElement('div', { className: 'closer', onClick: this.props.close })
      );
    }
  }]);
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                ...
                _react2.default.createElement(
                  ...
                  _react2.default.createElement('input', { type: 'text', name: 'email', id: 'email', placeholder: 'Email' })
                ),
                _react2.default.createElement(
                  'div',
                  { className: 'field' },
                  _react2.default.createElement('textarea', { name: 'message', id: 'message', rows: '4', placeholder: 'Message' })
                ),
                _react2.default.createElement(
                  'ul',
                  { className: 'actions' },
                  _react2.default.createElement(
                    'li',
                    null,
                    _react2.default.createElement('input', { type: 'submit', value: 'Send', className: 'special' })
                  ),
                  _react2.default.createElement(
                    'li',
                    null,
...
//# sourceMappingURL=static.b9a876ce.js.map